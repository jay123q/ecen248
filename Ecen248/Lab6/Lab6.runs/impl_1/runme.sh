...
HD_PWD='C:/Users/Joshua/Documents/Ecen248/Lab6/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_two_encoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_two_encoder.tcl -notrace
