...
HD_PWD='C:/Users/Joshua/Documents/Ecen248/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_two_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_two_encoder.tcl
